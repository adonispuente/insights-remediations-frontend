      ...
      {isLoading ? (
        ...
        <>
          <Title headingLevel="h5" size="md" className="pf-v6-u-mb-md">
            Select resolution
            <Tooltip
              content="A default resolution has been selected for you. To select a different resolution, use the options above."
              position="right"
            >
              <OutlinedQuestionCircleIcon className="pf-v6-u-ml-sm" />
            </Tooltip>
          </Title>
